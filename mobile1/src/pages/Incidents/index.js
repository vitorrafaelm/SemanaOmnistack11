...
export default function Incidents(){
    ...
    function navigateToDetail(incidents){
        //Detail é o nome da rota para onde se quer navegar
        //O segundo parametro são as informações que serão enviadas 
        //para a outra página que vamos navegar
        navigation.navigate('Detail', {incidents}); 
    }
    //use effect é uma função que é disparada quando as variáveis
    //que estão no array mudar
